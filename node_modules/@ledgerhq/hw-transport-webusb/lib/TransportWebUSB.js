...
var TransportWebUSB = /** @class */ (function (_super) {
    ...
    function TransportWebUSB(device, interfaceNumber) {
        ...
        _this.deviceModel = devices_1.identifyUSBProductId(device.productId);
        return _this;
    }
    /**
    ...
    TransportWebUSB.request = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, webusb_1.requestLedgerDevice()];
                    case 1:
                        device = _a.sent();
    ...
    TransportWebUSB.openConnected = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, webusb_1.getLedgerDevices()];
                    case 1:
                        devices = _a.sent();
                        if (devices.length === 0)
    ...
    TransportWebUSB.listen = function (observer) {
        ...
        webusb_1.getFirstLedgerDevice().then(function (device) {
            if (!unsubscribed) {
